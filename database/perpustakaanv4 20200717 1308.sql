...
--
-- Create schema perpustakaanv4
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ perpustakaanv4;
USE perpustakaanv4;

--
-- Table structure for table `perpustakaanv4`.`account`
--
...
--
-- Dumping data for table `perpustakaanv4`.`account`
--
...
--
-- Table structure for table `perpustakaanv4`.`icon`
--
...
--
-- Dumping data for table `perpustakaanv4`.`icon`
--
...
--
-- Table structure for table `perpustakaanv4`.`m_apilist`
--
...
--
-- Dumping data for table `perpustakaanv4`.`m_apilist`
--

/*!40000 ALTER TABLE `m_apilist` DISABLE KEYS */;
INSERT INTO `m_apilist` (`id`,`nama`,`link`) VALUES 
 (3,'Anggota Detail Kode Member','memberdetail?member_id=001'),
 (8,'Peminjaman Buku Kode Member','memberloan?member_id=001'),
 (9,'Denda Kode Member','memberfines?member_id=001');
/*!40000 ALTER TABLE `m_apilist` ENABLE KEYS */;


--
-- Table structure for table `perpustakaanv4`.`member`
--
...
--
-- Dumping data for table `perpustakaanv4`.`member`
--
...
--
-- Table structure for table `perpustakaanv4`.`options`
--
...
--
-- Dumping data for table `perpustakaanv4`.`options`
--

/*!40000 ALTER TABLE `options` DISABLE KEYS */;
INSERT INTO `options` (`id`,`name`,`value`) VALUES 
 (1,'site_title','e-Library'),
 (2,'site_description','Sistem Informasi Perpustakaan'),
...
--
-- Table structure for table `perpustakaanv4`.`pages`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pages`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_bahasa`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_bahasa`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_buku`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_buku`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_bulan`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_bulan`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_codepattern`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_codepattern`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_fines`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_fines`
--
...
INSERT INTO `pp_fines` (`id`,`fines_date`,`member_id`,`debet`,`credit`,`description`) VALUES 
 ...
 (15,'2020-05-19','001',2000,0,'Denda keterlambatan item  B00003');
/*!40000 ALTER TABLE `pp_fines` ENABLE KEYS */;


--
-- Table structure for table `perpustakaanv4`.`pp_gmd`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_gmd`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_item`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_item`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_kalaterbit`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_kalaterbit`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_loan`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_loan`
--
...
INSERT INTO `pp_loan` (`id`,`item_kode`,`member_id`,`loan_date`,`due_date`,`renewed`,`is_lent`,`is_return`,`return_date`,`last_update`,`user_id`) VALUES 
 ...
 (14,'B00002','001','2020-05-19','2020-05-26',0,1,0,NULL,NULL,'4'),
 (15,'B00003','001','2020-05-10','2020-05-17',0,1,1,'2020-05-19','2020-05-19 21:08:01','4');
/*!40000 ALTER TABLE `pp_loan` ENABLE KEYS */;


--
-- Table structure for table `perpustakaanv4`.`pp_lokasi`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_lokasi`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_member`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_member`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_member_type`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_member_type`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_pdf`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_pdf`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_penerbit`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_penerbit`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_pengarang`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_pengarang`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_statusitem`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_statusitem`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_sumberperolehan`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_sumberperolehan`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_supplier`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_supplier`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_tempatterbit`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_tempatterbit`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_tipeisi`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_tipeisi`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_tipekoleksi`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_tipekoleksi`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_tipemedia`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_tipemedia`
--
...
--
-- Table structure for table `perpustakaanv4`.`pp_topik`
--
...
--
-- Dumping data for table `perpustakaanv4`.`pp_topik`
--
...
--
-- Table structure for table `perpustakaanv4`.`user`
--
...
--
-- Dumping data for table `perpustakaanv4`.`user`
--
...
--
-- Table structure for table `perpustakaanv4`.`user_access_menu`
--
...
--
-- Dumping data for table `perpustakaanv4`.`user_access_menu`
--
...
--
-- Table structure for table `perpustakaanv4`.`user_access_submenu`
--
...
--
-- Dumping data for table `perpustakaanv4`.`user_access_submenu`
--
...
--
-- Table structure for table `perpustakaanv4`.`user_menu`
--
...
--
-- Dumping data for table `perpustakaanv4`.`user_menu`
--
...
INSERT INTO `user_menu` (`id`,`icon`,`menu_id`,`menu`) VALUES 
 ...
 (24,'fa fa-fw fa-wrench','api','API');
/*!40000 ALTER TABLE `user_menu` ENABLE KEYS */;


--
-- Table structure for table `perpustakaanv4`.`user_role`
--
...
--
-- Dumping data for table `perpustakaanv4`.`user_role`
--
...
--
-- Table structure for table `perpustakaanv4`.`user_sub_menu`
--
...
--
-- Dumping data for table `perpustakaanv4`.`user_sub_menu`
--
...
INSERT INTO `user_sub_menu` (`id`,`menu_id`,`title`,`url`,`icon`,`sort`,`is_active`) VALUES 
 ...
 (45,23,'Page','page','',1,1),
 (46,24,'API Public','api/apipublic','',1,1);
/*!40000 ALTER TABLE `user_sub_menu` ENABLE KEYS */;


--
-- Table structure for table `perpustakaanv4`.`user_token`
--
...
--
-- Dumping data for table `perpustakaanv4`.`user_token`
--
...
--
-- Table structure for table `perpustakaanv4`.`visitor_count`
--
...
--
-- Dumping data for table `perpustakaanv4`.`visitor_count`
--
...
--
-- Table structure for table `perpustakaanv4`.`web_setting`
--
...
--
-- Dumping data for table `perpustakaanv4`.`web_setting`
--
