    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/themes/opac/css/demo.css') ?>" />
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/themes/opac/css/style1.css') ?>" />
