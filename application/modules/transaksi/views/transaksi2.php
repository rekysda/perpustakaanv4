    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
          <div class="col-sm-3">
<form action="<?= base_url('transaksi/selesaitransaksi'); ?>" method="post"enctype="multipart/form-data">          
...
<?= $fine_each_day ?>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation">
        <a href="#peminjaman" aria-controls="peminjaman" role="tab" data-toggle="tab">PEMINJAMAN</a></li>
...
<div class="box">
<form action="<?= base_url('transaksi/tambahitem'); ?>" method="post"enctype="multipart/form-data">    
...
<tr>
<td align="center">
<a href="<?= base_url('transaksi/hapusitem/'.$items['rowid']); ?>">
...
<tr>
<td align="center">
<a href="<?= base_url('transaksi/kembaliitem/'.$dt['id'].'/'.$dendaperitem); ?>"onclick="return confirm('Anda yakin, akan mengembalikan eksemplar ini <?= $dt['item_kode']; ?>');">
<i class="fa fa-arrow-circle-right"></i>
</a>
</td>
<td align="center">
<?php if($dt['renewed']==$reborrow_limit){?>
<a href="<?= base_url('transaksi/perpanjangitem/'.$dt['id'].'/'.$dendaperitem); ?>"onclick="return confirm('Anda yakin, akan memperpanjang peminjaman untuk <?= $dt['item_kode']; ?>');">
...
<div class="box">
<?php if($getdenda){?>
  <form action="<?= base_url('transaksi/hapusdenda') ?>" method="post">
          <table  class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th width="10%">Edit</th>
                ...
                <tbody>
                  ...
                  <?php foreach ($getdenda as $dt) : ?>
                    <?php if($dt['sisa']>'0'){?>
                    <tr>
                    <td><a href="<?= base_url('transaksi/edit_denda/' . $dt['id']); ?>" class="btn btn-info btn-xs">Edit</a></td>
...
<div class="box">
<form action="<?= base_url('transaksi/tambahdenda') ?>" method="post"enctype="multipart/form-data">
...
<a href="<?= base_url('transaksi/transaksi2'); ?> " class="btn btn-default">Cancel</a>
</div>
</div>
</table>
</form>
